...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--waterfall">
  ...
  <div class="mdl-layout__drawer">
    <span class="mdl-layout-title" id="usertitle">Username</span>
  ...
  <main class="mdl-layout__content " style="padding-top: 80px;padding-left: 150px">
    ...
    <div class="card"><img src="images/5th/divisibilty.png" class="imag"><div class="gamename"><h2>Test of Divisibility</h2></div></div>
    <div class="card"><img src="images/5th/pl.png" class="imag"><div class="gamename"><h2>Profit & Loss</h2></div></div>
    <div class="card"><img src="images/5th/temp.png" style="margin-top: 3%" class="imag"><div class="gamename"><h2>Temperature Conversion</h2></div></div>
    <div class="card"><img src="images/5th/si.png" class="imag"><div class="gamename"><h2>Simple Interest</h2></div></div>
  </main>
</div>
</body>
</html>