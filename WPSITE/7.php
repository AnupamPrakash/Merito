...
function triangles()
{
  // alert("Enter");
  var score1=0;
a=Math.floor(1+Math.random()*80);
b=Math.floor(1+Math.random()*80);
c=prompt("Two degrees of a triangle are "+a+" & "+b+" . Enter the third degree");
d=(180-(a+b));
// alert(c);
if(c==d)
{
...
b=Math.floor(1+Math.random()*1000);
c=prompt("How much percentage is "+a+" of "+b+"?");
d=(a*100)/b;
d=Math.round(d);
if(c==d)
{
...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--waterfall">
  ...
  <main class="mdl-layout__content " style="padding-top: 80px;padding-left: 150px">
    ...
    <div class="card" onclick="triangles()"><img src="images/7th/tri.png" class="imag"><div class="gamename" ><h2>Triangles</h2></div></div>
    <div class="card" onclick="exp()"><img src="images/7th/ex.png" class="imag"><div class="gamename"><h2>Exponents & Powers</h2></div></div>
    <div class="card" onclick="com()"><img src="images/7th/com.png" style="margin-top: 0%" class="imag"><div class="gamename"><h2>Comparing Quantities</h2></div></div>
    <div class="card"><img src="images/7th/rat.png" class="imag"><div class="gamename"><h2>Rational Numbers</h2></div></div>
  </main>
</div>
</body>
</html>