...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--waterfall">
  ...
  <main class="mdl-layout__content " style="padding-top: 80px;padding-left: 150px">
    ...
    <div class="card"><img src="images/9th/ar.png" class="imag"  style="width: 20%;height: 90%"><div class="gamename"><h2>Surface Area & Volumes</h2></div></div>
    <div class="card"><img src="images/9th/prob.png" class="imag"><div class="gamename"><h2>Probabaility</h2></div></div>
    <div class="card"><img src="images/9th/poly.png" style="width: 20%;height: 90%" class="imag"><div class="gamename"><h2>Polynomials</h2></div></div>
    <div class="card"><img src="images/9th/hr.png" class="imag" style="width: 20%;height: 90%"><div class="gamename"><h2>Heron's Formula</h2></div></div>
  </main>
</div>
</body>
</html>